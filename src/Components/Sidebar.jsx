...
const Sidebar = ({
  ...
  const [chosen, setChosen] = useState("Platform Launch");
      ...
      {sidebar ? (
        ...
        >
          <div>
            ...
            <div>
              <h5 className="h-S">ALL BOARDS (3)</h5>
              <div>
                {settings.map((settings) => (
                  <div
                    key={Math.random()}
                    className={settings === chosen ? "chosen" : ""}
          ...
          <div>
            <div>
              ...
              <div
                className={toggler ? "toggle" : ""}
                onClick={() => setToggler((state) => !state)}
              ></div>
            ...
            {!mediaQuery ? (
              <p className="h-M" onClick={closeSidebar}>
        ...
        <div className="shower-sidebar" onClick={openSidebar}>
